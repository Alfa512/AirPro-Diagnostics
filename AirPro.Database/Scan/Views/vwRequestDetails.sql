...
GO
CREATE NONCLUSTERED INDEX [IX_ScanRequestDetails_RepairId]
    ON [Scan].[vwRequestDetails]([RepairId] ASC);


GO
CREATE UNIQUE CLUSTERED INDEX [PK_ScanRequestDetails]
    ON [Scan].[vwRequestDetails]([RequestId] ASC);
