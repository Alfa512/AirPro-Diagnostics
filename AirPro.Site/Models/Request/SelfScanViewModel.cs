...
{
    public class SelfScanViewModel : HasInsuranceSelectViewModel, IQuickRequest
    {
        ...
        public IEnumerable<SelectListItem> CategoryTypesSelectList { get; set; }
        ...
        public bool IsAssistedScanRecommended { get; set; }
