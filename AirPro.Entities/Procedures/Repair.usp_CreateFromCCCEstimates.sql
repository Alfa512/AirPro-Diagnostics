IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Repair' AND ROUTINE_NAME = 'usp_CreateFromCCCEstimates')
	DROP PROCEDURE Repair.usp_CreateFromCCCEstimates
GO
