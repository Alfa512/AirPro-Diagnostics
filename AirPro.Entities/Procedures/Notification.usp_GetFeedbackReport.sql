IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Reporting' AND ROUTINE_NAME = 'usp_GetFeedbackReport')
	DROP PROCEDURE Reporting.usp_GetFeedbackReport
GO
...
EXEC Reporting.usp_GetFeedbackReport
GO