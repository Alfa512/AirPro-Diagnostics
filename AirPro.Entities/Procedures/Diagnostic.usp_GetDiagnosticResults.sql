...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Diagnostic' AND ROUTINE_NAME = 'usp_GetDiagnosticResults')
	DROP PROCEDURE Diagnostic.usp_GetDiagnosticResults
GO
