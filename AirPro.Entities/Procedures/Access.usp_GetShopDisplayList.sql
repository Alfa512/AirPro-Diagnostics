IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Access' AND ROUTINE_NAME = 'usp_GetShopDisplayList')
	DROP PROCEDURE Access.usp_GetShopDisplayList
GO
