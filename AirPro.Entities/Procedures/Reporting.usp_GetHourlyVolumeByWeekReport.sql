IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Reporting' AND ROUTINE_NAME = 'usp_GetHourlyVolumeByWeekReport')
	DROP PROCEDURE Reporting.usp_GetHourlyVolumeByWeekReport
GO
