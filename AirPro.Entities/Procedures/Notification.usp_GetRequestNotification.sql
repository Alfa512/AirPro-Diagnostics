...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Notification' AND ROUTINE_NAME = 'usp_GetRequestNotification')
	DROP PROCEDURE Notification.usp_GetRequestNotification
GO
