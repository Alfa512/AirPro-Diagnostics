...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA = 'Access' AND ROUTINE_NAME = 'usp_ModifyAdminRights')
...
BEGIN
	...
	WHERE r.RoleGuid = '4FD55BFD-9E79-48C8-9FB0-DB5281D5005F'
	ORDER BY Email
